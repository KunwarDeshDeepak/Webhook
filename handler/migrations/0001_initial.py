# Generated by Django 2.1.7 on 2019-03-09 13:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jira_actions', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='handler.SasSActions', unique=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='sheet_actions',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='handler.SheetActions'),
        ),
        migrations.AddField(
            model_name='sasssheetmap',
            name='user',
